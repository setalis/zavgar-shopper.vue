...
<template>
    ...
    <Container class="py-8 sm:py-12">
        <nav
            ...
            :aria-label="t('shop.brand_page.breadcrumb')"
        >
            <Link
                :href="home.url()"
                class="transition hover:text-zinc-900 dark:hover:text-white"
                >{{ t('shop.brand_page.breadcrumb.home') }}</Link
            >
            <span>/</span>
            <span class="text-zinc-900 dark:text-white">{{ brand.name }}</span>
        </nav>
        ...
        <template v-else>
            ...
            <nav
                ...
                :aria-label="t('shop.brand_page.pagination')"
            >
                <Link
